...
from app.services.fallback_service import local_medical_analysis
...
def analyze_text(
    ...
    """
    Сначала пытается получить результат через DeepSeek.
    Если AI-ответ недоступен или невалиден, использует локальный fallback.
